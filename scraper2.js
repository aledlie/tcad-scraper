...
function scrapePropertyTaxInformation() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, url, propertyData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    page = _a.sent();
                    url = 'https://www.illuminationholidaylighting.com/';
                    _a.label = 3;
                case 3:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, page.evaluate(function () {
                            var propertyInfo = [];
                            var propertyRows = document.querySelectorAll('[href="https://www.illuminationholidaylighting.com/residential-1/"]');
